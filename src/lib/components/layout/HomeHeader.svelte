...
<header class="w-full py-4 absolute top-0 left-0 right-0 z-50">
    <div class="container mx-auto px-4">
                ...
                {#each navigationLinks as link}
                    {#if link.title === "Services"}
                        <div class="relative group">
                            <button
                                class="flex items-center text-surface-700-200 hover:text-primary-300 transition-colors font-medium"
                    ...
                    {:else}
                        <a
                            href={link.href}
                            class="text-surface-700-200 hover:text-primary-300 transition-colors font-medium"
                        >
                            {link.title}
                        </a>
                    {/if}
        ...
        {#if isMenuOpen}
            <div id="mobile-menu" class="md:hidden mt-4 space-y-4 bg-white dark:bg-surface-900 rounded-lg p-4 shadow-lg">
                <a
                    href="/services"
